...
module.exports = function (input, options, cb) {
  ...
  fs.readFile(input, function (err, markdownContent) {
    ...
    var githubMarkdownCssPath =
      "node_modules/github-markdown-css/github-markdown.css";
    var highlightjsDefaultCssPath =
      "node_modules/highlight.js/styles/default.css";
    var highlightjsGithubCssPath =
      "node_modules/highlight.js/styles/github.css";

    var htmlHeader =
      '<meta charset="utf-8">' +
      '<link rel="stylesheet" href="' +
      path.resolve(githubMarkdownCssPath) +
      '">' +
      '<link rel="stylesheet" href="' +
      path.resolve(highlightjsDefaultCssPath) +
      '">' +
      '<link rel="stylesheet" href="' +
      path.resolve(highlightjsGithubCssPath) +
      '">';

    // inject custom css if exist
    // todo: validate css
    options.customCss.forEach(
      (_) =>
        (htmlHeader += '<link rel="stylesheet" href="' + path.resolve(_) + '">')
    );
    ...
    var tmpHTMLPath = path.join(
      os.tmpdir(),
      path.parse(input).name + "-" + uuid() + ".html"
    );
